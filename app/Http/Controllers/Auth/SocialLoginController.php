...
class SocialLoginController extends Controller
{
    ...
    public function social_login(Request $request) { 
        ...
        try{
            ...
            $FacebookSql = User::where('social_unique_id',$request->social_unique_id);
            if($request->email !=""){
            ...
            if($AuthUser){
                ...
                $AuthUser->mobile=$request->mobile?:'';
                $AuthUser->country_code=$request->country_code?:'+233';
                $AuthUser->picture=$request->picture;
                $AuthUser->otp_activation=1; 
                $rand = rand(100, 999);
            ...
            return response()->json(['status'=>false,'message' => trans('api.something_went_wrong')],200);
        }
    }
