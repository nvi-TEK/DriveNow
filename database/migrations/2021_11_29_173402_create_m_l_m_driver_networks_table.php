...
class CreateMLMDriverCommissionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_l_m_driver_commissions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('m_l_m_driver_commissions');
    }
}
